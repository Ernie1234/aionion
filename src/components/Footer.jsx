    ...
    <footer className="bg-gray-900 text-white py-4 px-6 md:py-6 lg:py-10">
      <div className="w-full md:max-w-screen-md lg:max-w-screen-lg m-auto flex flex-col justify-center items-center">
        <p className="text-center">
          ...
          tokens to earn Solana and other solana projects. $Aion skaking
          platform will have a farming pool which will accomodate other projects
          of the solana ecosystem, where users can stake tokens and be rewarded.
          Active users of Ai-Onion swap and staking platforms will be airdropped
        </p>
